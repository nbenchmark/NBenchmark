...
/// <summary>
///     Marks an MSTest test method as a performance benchmark, gated on the thresholds set here, in place
///     of <see cref="TestMethodAttribute" />'s default execution.
/// </summary>
/// <param name="callerFilePath">Captured automatically; do not pass explicitly.</param>
/// <param name="callerLineNumber">Captured automatically; do not pass explicitly.</param>
    ...
    : TestMethodAttribute(callerFilePath, callerLineNumber), IPerformanceThresholds
{
    ...
    /// <summary>Measures the test method and returns its outcome as a gated MSTest result.</summary>
