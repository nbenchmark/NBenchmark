...
public enum WarmupStopReason
{
    ...
    /// <summary>The warmup ceiling (<see cref="AutoTuneOptions.MaxWarmup" />) was reached before settling.</summary>
    MaxCeiling = 1,

    /// <summary>Warmup ran a user-pinned exact count (<see cref="MeasurementOptions.WarmupIterations" />).</summary>
    ExplicitCount = 2,
