...
---------|--------------------------|----------|--------------------------------------------------------------------
 ...
 NB0003  | NBenchmark.Usage         | Error    | [Arguments] / [ArgumentsSource] must match method parameters.
 ...
 NB0012  | NBenchmark.Usage         | Error    | [ArgumentsSource] cannot be combined with [Arguments].
