...
Each page is self-contained but assumes you have read the surface-level treatment first - the feature page for the behaviour, the statistics page for the math.
